    ...
    <Card className="w-full max-w-md shadow-lg mx-auto">
      <CardHeader className="space-y-1">
        ...
        <CardDescription className="text-center">
          ...
          <p style={{display: isDemo ? "initial" : "none"}}>Demo credentials:<br/>- <b>Student</b>: student@demo.local :
            demo123<br/>- <b>Teacher</b>: teacher@demo.local : demo123<br/>- <b>Admin</b>: admin@demo.local : demo123
          </p>
        </CardDescription>
