...
import {AlertCircleIcon, ChevronRightIcon, UserCircleIcon, UsersIcon} from "lucide-react";
      ...
      <div
        ...
        <div className="flex flex-col gap-6 w-full justify-start">
          ...
          {adminStore.classes.map(classroom =>
            <Card
              className={"flex flex-row items-center gap-4 px-2 py-2 w-full justify-start ring-sidebar-ring" + ((selectedClass?.classId == classroom.classId) ? " ring-1" : "")}
