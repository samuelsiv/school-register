  ...
  return <motion.div layout key={"hwcard-" + homework.homeworkId} layoutId={"hwcard-" + homework.homeworkId.toString()}>
    <Card className="flex flex-col gap-1 items-center p-4 justify-between border-t-[2px]"
      ...
      <motion.p className="text-xl font-light"
                layoutId={"hwcard-subj" + homework.homeworkId}>{homework.subjectName} - {homework.teacherName}</motion.p>
      <motion.h1 className="text-2xl font-bold"
                 layoutId={"hwcard-title" + homework.homeworkId}>{homework.title}</motion.h1>
