        ...
        <CardContent>
          <div>
            ...
            <AnimatePresence key={"subject"}>
              {(selectedAverage != null) &&
                  <motion.div layout key={"avercard-" + selectedAverage.subjectId}
                              layoutId={"avercard-" + selectedAverage.subjectId.toString()}>
                      <AverageExpandedCard selectedAverage={selectedAverage} goBack={() => {
