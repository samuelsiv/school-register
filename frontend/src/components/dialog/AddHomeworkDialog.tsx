...
export function AddHomeworkDialog({subjects, teacherId, classId, onCreate}: {
  subjects: Subject[],
  teacherId: number,
  classId: number,
  onCreate: () => void
                  ...
                  <FormControl>
                    <div
                      ...
                      <Select onValueChange={(value) => field.onChange(parseInt(value))}
                        ...
                        <SelectContent>
                          {subjects.map(subject => <SelectItem value={subject.subjectId.toString()}
                                                               key={"sub-" + subject.subjectId.toString()}>{subject.subjectName}</SelectItem>)}
                        </SelectContent>
                      </Select>
                    </div>
                  </FormControl>
